...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ConversationCityNames'
        db.create_table('utils_conversationcitynames', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('unusable_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('usable_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('utils', ['ConversationCityNames'])


    def backwards(self, orm):
        # Deleting model 'ConversationCityNames'
        db.delete_table('utils_conversationcitynames')
