...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UnhabitatRecordLog.raw_data'
        db.alter_column('utils_unhabitatrecordlog', 'raw_data', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'UnhabitatRecordLog.raw_data'
        db.alter_column('utils_unhabitatrecordlog', 'raw_data', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
