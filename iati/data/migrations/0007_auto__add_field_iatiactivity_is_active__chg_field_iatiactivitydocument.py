...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IATIActivity.is_active'
        db.add_column('data_iatiactivity', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'IATIActivityDocument.language'
        db.alter_column('data_iatiactivitydocument', 'language_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Language'], null=True))

        # Changing field 'IATIActivityDocument.format'
        db.alter_column('data_iatiactivitydocument', 'format', self.gf('django.db.models.fields.CharField')(max_length=55, null=True))

    def backwards(self, orm):
        # Deleting field 'IATIActivity.is_active'
        db.delete_column('data_iatiactivity', 'is_active')


        # Changing field 'IATIActivityDocument.language'
        db.alter_column('data_iatiactivitydocument', 'language_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['data.Language']))

        # Changing field 'IATIActivityDocument.format'
        db.alter_column('data_iatiactivitydocument', 'format', self.gf('django.db.models.fields.CharField')(default='', max_length=55))
