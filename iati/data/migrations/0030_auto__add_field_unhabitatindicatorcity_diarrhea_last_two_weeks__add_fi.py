...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UnHabitatIndicatorCity.diarrhea_last_two_weeks'
        db.add_column('data_unhabitatindicatorcity', 'diarrhea_last_two_weeks',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UnHabitatIndicatorCity.diarrhea_had_ari'
        db.add_column('data_unhabitatindicatorcity', 'diarrhea_had_ari',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UnHabitatIndicatorCity.fever_last_two_weeks'
        db.add_column('data_unhabitatindicatorcity', 'fever_last_two_weeks',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UnHabitatIndicatorCity.perc_malnourished'
        db.add_column('data_unhabitatindicatorcity', 'perc_malnourished',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UnHabitatIndicatorCity.perc_measles'
        db.add_column('data_unhabitatindicatorcity', 'perc_measles',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UnHabitatIndicatorCity.diarrhea_last_two_weeks'
        db.delete_column('data_unhabitatindicatorcity', 'diarrhea_last_two_weeks')

        # Deleting field 'UnHabitatIndicatorCity.diarrhea_had_ari'
        db.delete_column('data_unhabitatindicatorcity', 'diarrhea_had_ari')

        # Deleting field 'UnHabitatIndicatorCity.fever_last_two_weeks'
        db.delete_column('data_unhabitatindicatorcity', 'fever_last_two_weeks')

        # Deleting field 'UnHabitatIndicatorCity.perc_malnourished'
        db.delete_column('data_unhabitatindicatorcity', 'perc_malnourished')

        # Deleting field 'UnHabitatIndicatorCity.perc_measles'
        db.delete_column('data_unhabitatindicatorcity', 'perc_measles')
