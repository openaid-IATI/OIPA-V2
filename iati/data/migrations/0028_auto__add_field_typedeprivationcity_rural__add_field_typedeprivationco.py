...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TypeDeprivationCity.rural'
        db.add_column('data_typedeprivationcity', 'rural',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'TypeDeprivationCountry.rural'
        db.add_column('data_typedeprivationcountry', 'rural',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TypeDeprivationCity.rural'
        db.delete_column('data_typedeprivationcity', 'rural')

        # Deleting field 'TypeDeprivationCountry.rural'
        db.delete_column('data_typedeprivationcountry', 'rural')
