...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Indicator.friendly_label'
        db.add_column('data_indicator', 'friendly_label',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Indicator.type_data'
        db.add_column('data_indicator', 'type_data',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Indicator.friendly_label'
        db.delete_column('data_indicator', 'friendly_label')

        # Deleting field 'Indicator.type_data'
        db.delete_column('data_indicator', 'type_data')
