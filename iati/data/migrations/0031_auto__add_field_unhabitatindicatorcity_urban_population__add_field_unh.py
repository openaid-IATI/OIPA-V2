...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UnHabitatIndicatorCity.urban_population'
        db.add_column('data_unhabitatindicatorcity', 'urban_population',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UnHabitatIndicatorCountry.urban_population'
        db.add_column('data_unhabitatindicatorcountry', 'urban_population',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UnHabitatIndicatorCity.urban_population'
        db.delete_column('data_unhabitatindicatorcity', 'urban_population')

        # Deleting field 'UnHabitatIndicatorCountry.urban_population'
        db.delete_column('data_unhabitatindicatorcountry', 'urban_population')
