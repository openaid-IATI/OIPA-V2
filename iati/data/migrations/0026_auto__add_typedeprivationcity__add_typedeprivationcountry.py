...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TypeDeprivationCity'
        db.create_table('data_typedeprivationcity', (
            ...
            ('three_shelter_deprivations', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('four_shelter_deprivations', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('gender', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('extra_type_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('is_matrix', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('type_deprivation', self.gf('django.db.models.fields.IntegerField')()),
            ('indicator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.UnHabitatIndicatorCity'])),
        ))
        db.send_create_signal('data', ['TypeDeprivationCity'])

        # Adding model 'TypeDeprivationCountry'
        db.create_table('data_typedeprivationcountry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('urban', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('total', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('non_slum_household', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ...
            ('is_matrix', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('type_deprivation', self.gf('django.db.models.fields.IntegerField')()),
            ('indicator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.UnHabitatIndicatorCountry'])),
        ))
        db.send_create_signal('data', ['TypeDeprivationCountry'])


    def backwards(self, orm):
        # Deleting model 'TypeDeprivationCity'
        db.delete_table('data_typedeprivationcity')

        # Deleting model 'TypeDeprivationCountry'
        db.delete_table('data_typedeprivationcountry')
