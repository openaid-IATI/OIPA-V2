...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrganisationStatistics'
        db.create_table('data_organisationstatistics', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('organisation', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['data.Organisation'], unique=True)),
            ('total_activities', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('data', ['OrganisationStatistics'])


    def backwards(self, orm):
        # Deleting model 'OrganisationStatistics'
        db.delete_table('data_organisationstatistics')
