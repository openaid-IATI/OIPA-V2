...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UnHabitatIndicatorCity.pop_urban_agglomerations'
        db.add_column('data_unhabitatindicatorcity', 'pop_urban_agglomerations',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UnHabitatIndicatorCountry.avg_annual_rate_change_total_population'
        db.add_column('data_unhabitatindicatorcountry', 'avg_annual_rate_change_total_population',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UnHabitatIndicatorCountry.avg_annual_rate_change_urban_agglomerations'
        db.add_column('data_unhabitatindicatorcountry', 'avg_annual_rate_change_urban_agglomerations',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UnHabitatIndicatorCountry.avg_annual_rate_change_percentage_urban'
        db.add_column('data_unhabitatindicatorcountry', 'avg_annual_rate_change_percentage_urban',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UnHabitatIndicatorCity.pop_urban_agglomerations'
        db.delete_column('data_unhabitatindicatorcity', 'pop_urban_agglomerations')

        # Deleting field 'UnHabitatIndicatorCountry.avg_annual_rate_change_total_population'
        db.delete_column('data_unhabitatindicatorcountry', 'avg_annual_rate_change_total_population')

        # Deleting field 'UnHabitatIndicatorCountry.avg_annual_rate_change_urban_agglomerations'
        db.delete_column('data_unhabitatindicatorcountry', 'avg_annual_rate_change_urban_agglomerations')

        # Deleting field 'UnHabitatIndicatorCountry.avg_annual_rate_change_percentage_urban'
        db.delete_column('data_unhabitatindicatorcountry', 'avg_annual_rate_change_percentage_urban')
