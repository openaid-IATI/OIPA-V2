...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Country.latitude'
        db.add_column('data_country', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Country.longitude'
        db.add_column('data_country', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Country.latitude'
        db.delete_column('data_country', 'latitude')

        # Deleting field 'Country.longitude'
        db.delete_column('data_country', 'longitude')
