...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CurrencyType.description'
        db.delete_column('data_currencytype', 'description')

        # Deleting field 'CurrencyType.name'
        db.delete_column('data_currencytype', 'name')


        # Changing field 'CurrencyType.code'
        db.alter_column('data_currencytype', 'code', self.gf('django.db.models.fields.CharField')(max_length=3, primary_key=True))
        # Adding field 'Transaction.currency'
        db.add_column('data_transaction', 'currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.CurrencyType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CurrencyType.description'
        db.add_column('data_currencytype', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CurrencyType.name'
        db.add_column('data_currencytype', 'name',
                      self.gf('django.db.models.fields.CharField')(default='USD', max_length=15),
                      keep_default=False)


        # Changing field 'CurrencyType.code'
        db.alter_column('data_currencytype', 'code', self.gf('django.db.models.fields.IntegerField')(primary_key=True))
        # Deleting field 'Transaction.currency'
        db.delete_column('data_transaction', 'currency_id')
