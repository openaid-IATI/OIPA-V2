...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UnHabitatIndicatorCity.enrollment_female_primary_education'
        db.add_column('data_unhabitatindicatorcity', 'enrollment_female_primary_education',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UnHabitatIndicatorCity.enrollment_male_primary_education'
        db.add_column('data_unhabitatindicatorcity', 'enrollment_male_primary_education',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UnHabitatIndicatorCountry.enrollment_female_primary_education'
        db.add_column('data_unhabitatindicatorcountry', 'enrollment_female_primary_education',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UnHabitatIndicatorCountry.enrollment_male_primary_education'
        db.add_column('data_unhabitatindicatorcountry', 'enrollment_male_primary_education',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UnHabitatIndicatorCity.enrollment_female_primary_education'
        db.delete_column('data_unhabitatindicatorcity', 'enrollment_female_primary_education')

        # Deleting field 'UnHabitatIndicatorCity.enrollment_male_primary_education'
        db.delete_column('data_unhabitatindicatorcity', 'enrollment_male_primary_education')

        # Deleting field 'UnHabitatIndicatorCountry.enrollment_female_primary_education'
        db.delete_column('data_unhabitatindicatorcountry', 'enrollment_female_primary_education')

        # Deleting field 'UnHabitatIndicatorCountry.enrollment_male_primary_education'
        db.delete_column('data_unhabitatindicatorcountry', 'enrollment_male_primary_education')
