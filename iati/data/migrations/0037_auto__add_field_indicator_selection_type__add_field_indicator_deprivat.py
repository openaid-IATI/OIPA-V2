...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Indicator.selection_type'
        db.add_column('data_indicator', 'selection_type',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Indicator.deprivation_type'
        db.add_column('data_indicator', 'deprivation_type',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Indicator.selection_type'
        db.delete_column('data_indicator', 'selection_type')

        # Deleting field 'Indicator.deprivation_type'
        db.delete_column('data_indicator', 'deprivation_type')
