...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UnHabitatIndicatorCity.improved_floor'
        db.add_column('data_unhabitatindicatorcity', 'improved_floor',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UnHabitatIndicatorCity.sufficient_living'
        db.add_column('data_unhabitatindicatorcity', 'sufficient_living',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UnHabitatIndicatorCity.has_telephone'
        db.add_column('data_unhabitatindicatorcity', 'has_telephone',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UnHabitatIndicatorCity.connection_to_electricity'
        db.add_column('data_unhabitatindicatorcity', 'connection_to_electricity',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UnHabitatIndicatorCity.improved_floor'
        db.delete_column('data_unhabitatindicatorcity', 'improved_floor')

        # Deleting field 'UnHabitatIndicatorCity.sufficient_living'
        db.delete_column('data_unhabitatindicatorcity', 'sufficient_living')

        # Deleting field 'UnHabitatIndicatorCity.has_telephone'
        db.delete_column('data_unhabitatindicatorcity', 'has_telephone')

        # Deleting field 'UnHabitatIndicatorCity.connection_to_electricity'
        db.delete_column('data_unhabitatindicatorcity', 'connection_to_electricity')
