...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityStatistics.id'
        db.add_column('data_activitystatistics', 'id',
                      self.gf('django.db.models.fields.AutoField')(default=1, primary_key=True),
                      keep_default=False)


        # Renaming column for 'ActivityStatistics.iati_identifier' to match new field type.
        db.rename_column('data_activitystatistics', 'iati_identifier', 'iati_identifier_id')
        # Changing field 'ActivityStatistics.iati_identifier'
        db.alter_column('data_activitystatistics', 'iati_identifier_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['data.IATIActivity'], unique=True))
        # Adding index on 'ActivityStatistics', fields ['iati_identifier']
        db.create_index('data_activitystatistics', ['iati_identifier_id'])


    def backwards(self, orm):
        # Removing index on 'ActivityStatistics', fields ['iati_identifier']
        db.delete_index('data_activitystatistics', ['iati_identifier_id'])

        # Deleting field 'ActivityStatistics.id'
        db.delete_column('data_activitystatistics', 'id')


        # Renaming column for 'ActivityStatistics.iati_identifier' to match new field type.
        db.rename_column('data_activitystatistics', 'iati_identifier_id', 'iati_identifier')
        # Changing field 'ActivityStatistics.iati_identifier'
        db.alter_column('data_activitystatistics', 'iati_identifier', self.gf('django.db.models.fields.CharField')(max_length=50, primary_key=True))
