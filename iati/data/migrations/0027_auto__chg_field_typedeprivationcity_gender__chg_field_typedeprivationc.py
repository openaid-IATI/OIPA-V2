...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TypeDeprivationCity.gender'
        db.alter_column('data_typedeprivationcity', 'gender', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'TypeDeprivationCountry.gender'
        db.alter_column('data_typedeprivationcountry', 'gender', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'TypeDeprivationCity.gender'
        db.alter_column('data_typedeprivationcity', 'gender', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'TypeDeprivationCountry.gender'
        db.alter_column('data_typedeprivationcountry', 'gender', self.gf('django.db.models.fields.BooleanField')())
