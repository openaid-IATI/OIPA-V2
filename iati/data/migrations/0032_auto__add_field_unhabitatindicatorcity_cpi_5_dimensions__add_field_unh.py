...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UnHabitatIndicatorCity.cpi_5_dimensions'
        db.add_column('data_unhabitatindicatorcity', 'cpi_5_dimensions',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UnHabitatIndicatorCity.cpi_4_dimensions'
        db.add_column('data_unhabitatindicatorcity', 'cpi_4_dimensions',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UnHabitatIndicatorCity.cpi_productivity_index'
        db.add_column('data_unhabitatindicatorcity', 'cpi_productivity_index',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UnHabitatIndicatorCity.cpi_quality_of_live_index'
        db.add_column('data_unhabitatindicatorcity', 'cpi_quality_of_live_index',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UnHabitatIndicatorCity.cpi_infrastructure_index'
        db.add_column('data_unhabitatindicatorcity', 'cpi_infrastructure_index',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UnHabitatIndicatorCity.cpi_environment_index'
        db.add_column('data_unhabitatindicatorcity', 'cpi_environment_index',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UnHabitatIndicatorCity.cpi_equity_index'
        db.add_column('data_unhabitatindicatorcity', 'cpi_equity_index',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UnHabitatIndicatorCity.cpi_5_dimensions'
        db.delete_column('data_unhabitatindicatorcity', 'cpi_5_dimensions')

        # Deleting field 'UnHabitatIndicatorCity.cpi_4_dimensions'
        db.delete_column('data_unhabitatindicatorcity', 'cpi_4_dimensions')

        # Deleting field 'UnHabitatIndicatorCity.cpi_productivity_index'
        db.delete_column('data_unhabitatindicatorcity', 'cpi_productivity_index')

        # Deleting field 'UnHabitatIndicatorCity.cpi_quality_of_live_index'
        db.delete_column('data_unhabitatindicatorcity', 'cpi_quality_of_live_index')

        # Deleting field 'UnHabitatIndicatorCity.cpi_infrastructure_index'
        db.delete_column('data_unhabitatindicatorcity', 'cpi_infrastructure_index')

        # Deleting field 'UnHabitatIndicatorCity.cpi_environment_index'
        db.delete_column('data_unhabitatindicatorcity', 'cpi_environment_index')

        # Deleting field 'UnHabitatIndicatorCity.cpi_equity_index'
        db.delete_column('data_unhabitatindicatorcity', 'cpi_equity_index')
