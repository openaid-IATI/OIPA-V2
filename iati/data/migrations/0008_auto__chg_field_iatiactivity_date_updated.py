...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IATIActivity.date_updated'
        db.alter_column('data_iatiactivity', 'date_updated', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'IATIActivity.date_updated'
        db.alter_column('data_iatiactivity', 'date_updated', self.gf('django.db.models.fields.DateField')(default=''))
